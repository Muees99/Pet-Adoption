...
//       <div className="max-w-[1440px] mx-auto sm:px-[5%] px-[4%] flex flex-col justify-center items-center">
//         <div className="text-center my-10">
//           <h2 className="text-white text-2xl md:text-4xl sm:text-2xl leading-[140%] font-semibold">
//             Adoption Process Information
//           </h2>
//         </div>
//         <div className="flex flex-col md:flex-row justify-between items-start w-full text-white">
